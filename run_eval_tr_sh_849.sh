SAVE_PATH=/yrfs1/intern/tjshen/PIE-eval/Tr_8m4_sh_PIE12w_new_RM
...
dglke_train --model_name TransE_l2 \
  ...
  --val_candidate_path /train14/sli/jswang19/my_OGB/wikikg90m-v2/processed/my13/valid_candidate_12w.npy \
