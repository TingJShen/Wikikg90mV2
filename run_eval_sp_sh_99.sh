SAVE_PATH=/yrfs1/intern/tjshen/PIE-eval/Sp_1m_sh_PIE12w_RM32_hr299_1s_RM
...
dglke_train --model_name SimplE \
  --hidden_dim 400 --gamma 10  --valid  -adv --mix_cpu_gpu --num_proc 1 --num_thread 1 \
  --async_update \
  --print_on_screen \
  ...
  --val_candidate_path /train14/sli/jswang19/OGB/wikikg90m-v2/merge_candidate/PIE12w_RM32_hr299_1s.npy \
