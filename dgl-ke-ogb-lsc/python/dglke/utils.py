...
def save_model(args, model, emap_file=None, rmap_file=None,index=99):
    if not os.path.exists(args.save_path):
        os.mkdir(args.save_path)
    print('Save model to {}'.format(args.save_path))
    model.save_emb(args.save_path, args.dataset,index)
    ...
    def __init__(self):
        ...
        self.add_argument('--model_name', default='TransE',
                          choices=['TransE', 'TransE_l1', 'TransE_l2', 'TransR',
                                   ...
                                   'SimplE', 'PairRE', 'PairRotatE','Auto', 'OTE'],
        ...
        self.add_argument('--save_step', type=int, default=2000000,
                          help='save_step')
        self.add_argument('--no_load', action='store_true',
                          help='Disable load pretrain')
        self.add_argument('--load_path', type=str, default='ckpts',
                          help='the path of the directory where models and logs are saved.')
        self.add_argument('--index', type=str, default='499999',
                          help='the path of the directory where models and logs are saved.')
        self.add_argument('--val_candidate_path', type=str, default='1.npy',
                          help='the path of the directory where models and logs are saved.')
        self.add_argument('--trainhrt_path', type=str, default='2.npy',
                          help='the path of the directory where models and logs are saved.')
        # 学习率衰减被PIE删了
