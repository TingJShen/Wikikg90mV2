SAVE_PATH=/yrfs1/intern/tjshen/PIE-eval/Cont_Tr_2m9_sh_PIE_100100_Transe_index_precise
...
CUDA_VISIBLE_DEVICES=0,1,2,3 dglke_train --model_name TransE_l2 \
  --hidden_dim 200 --gamma 10  --valid  -adv --mix_cpu_gpu --num_proc 1 --num_thread 1 \
  --gpu 0 1 2 3 \
  --async_update \
  --print_on_screen \
  ...
  --max_step 1000000  --force_sync_interval 1000 --eval_interval 10000 --save_step 100000\
  ...
  --load_path /yrfs1/intern/tjshen/PIE-eval/Cont_Tr_2m9_sh_PIE_100100_Transe_index_precise/TransE_l2_wikikg90m_shallow_d_200_g_10.00 \
  --index 239999 --no_save_emb\
  #--no_load \