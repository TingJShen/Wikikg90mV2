SAVE_PATH=/yrfs1/intern/tjshen/PIE-eval/Cont_Tr_9m9_sh_PIE_100100_Transe_index_precise
...
CUDA_VISIBLE_DEVICES=0,1,2,3 dglke_train --model_name TransE_l2 \
  ...
  --max_step 1000000  --force_sync_interval 1000 --eval_interval 10000 --save_step 200000\
