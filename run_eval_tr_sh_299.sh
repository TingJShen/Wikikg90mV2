SAVE_PATH=/yrfs1/intern/tjshen/PIE-eval/Tr_1m9_sh_TD_PIE6w_RM32_off
...
dglke_train --model_name TransE_l2 \
  ...
  --load_path /yrfs1/intern/tjshen/PIE-model/Tr_5m_sh_PIE_off/TransE_l2_wikikg90m_shallow_d_200_g_10.00 \
